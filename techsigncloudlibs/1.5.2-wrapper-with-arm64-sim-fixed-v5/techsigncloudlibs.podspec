Pod::Spec.new do |s|
    ...
    s.version      = "1.5.2-wrapper-with-arm64-sim-fixed-v5"
    ...
    s.source       = { :git => "https://github.com/soneratmaca00/PODSPECS-master.git", :tag => "1.5.2-wrapper-with-arm64-sim-fixed-v5" }
